...
A notable difference between the data series is for Russian crises. Reinhart and Rogoff and Laeven and Valencia both record a crisis in the late 2000s, though their timing differ slightly. However, there is no noticeable change in the EPFMS during this period. [CHECK WHEN RESULTS ARE UPDATED]

Overall, this suggests that the EPFMS Index does capture aspects of financial market stress, but does so in a unique way that sheds light on processes not captured well by previous indices.
