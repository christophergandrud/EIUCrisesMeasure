...
The shadded boxes in figures \ref{compare_1} and \ref{compare_2} show the periods where @laeven2013 and @Reinhart2009[^reinhart-address] classify there as being a banking crisis.
...
[^lv-address]: We used data downloaded from: <https://www.imf.org/external/pubs/cat/longres.aspx?sk=26015.0>. Accessed May 2015.

[^reinhart-address]: We used data downloaded from: <http://www.carmenreinhart.com/data/browse-by-topic/topics/7/>. Accessed May 2015.
