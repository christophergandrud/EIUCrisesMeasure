...
A notable difference between the data series is for Russian. Reinhart and Rogoff and Laeven and Valencia both record a crisis in the late 2000s, though their timing differ slightly. However, there is no noticeable change in the EPFMS during this period. This suggests that perceptions of Russian financial markets in real-time EIU documents did not noticeably indicate a change in conditions. [CHECK WHEN RESULTS ARE UPDATED]
