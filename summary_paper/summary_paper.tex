...
\begin{center}
    \textbf{Working Draft \\ Being Prepared for the APSA 2015 Annual Conference, San Francisco}
\end{center}
...
We then examined how politician's electoral safety may effect changes to `off-trend' debt. To do this we created a dependent variable of the year-on-year change in the debt residuals. Table \ref{results_elect} shows results from models examining the relationship between electoral safety and changes to off-trend financial stress debt.
