...
forest regression (Jones and Linder 2015) to examine the relationships
between word stems from the texts and the Perceptions Index. Second, we
compared the Index to previous indices using an `interocular' test,
...
in this context because there are many variables--in this case 833
stems--relative to the number of documents--7,888. The result of this
analysis that we focus on is variable importance.
